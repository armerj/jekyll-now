...
I could recover all the keys if I could get the private key for a 256-bit RSA key. Unlike the other RSA keys, the 256-bit key was exactly 256 bits meaning it was likely not backdoored. There are publicly available tools to factor 256-bit keys. I used [yafu](https://sites.google.com/site/bbuhrow/home), and it was done in a few minutes. 
